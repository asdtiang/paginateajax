...
class AjaxPaginateTagLib {
	...
	def jquery={attrs ->
	   ...
	   // println params
        ...
        writer<<"""
		<span id="ajaxSelectText"><select id="ajaxSelect" onchange="
        ...
        if(sample!=true){
            writer<<"""
			 <span id="ajaxMaxText"> ${showText}</span><select id="ajaxMax" onchange="
